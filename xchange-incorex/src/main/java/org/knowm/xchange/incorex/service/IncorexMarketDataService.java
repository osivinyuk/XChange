...
public class IncorexMarketDataService extends IncorexMarketDataServiceRaw implements MarketDataService {
  public IncorexMarketDataService(Exchange exchange) {
    super(exchange);
  }
