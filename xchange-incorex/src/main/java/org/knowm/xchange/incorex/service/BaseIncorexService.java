...
import org.knowm.xchange.incorex.Exmo;
import org.knowm.xchange.incorex.ExmoDigest;
import org.knowm.xchange.service.BaseExchangeService;
import si.mazi.rescu.RestProxyFactory;

public class BaseExmoService extends BaseExchangeService {
  protected final Exmo incorex;
  ...
  protected BaseExmoService(Exchange exchange) {
    ...
    this.incorex =
        RestProxyFactory.createProxy(
            Incorex.class, exchangeSpecification.getSslUri(), getClientConfig());
    this.apiKey = exchangeSpecification.getApiKey();
    this.signatureCreator = IncorexDigest.createInstance(exchangeSpecification.getSecretKey());
  }
