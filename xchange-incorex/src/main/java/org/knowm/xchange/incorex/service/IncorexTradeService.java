...
import org.knowm.xchange.incorex.dto.trade.IncorexTradeHistoryParams;
...
public class IncorexTradeService extends IncorexTradeServiceRaw implements TradeService {
  public IncorexTradeService(IncorexExchange incorexExchange) {
  ...
  public boolean cancelOrder(CancelOrderParams orderParams) throws IOException {
    if (orderParams instanceof CancelOrderByIdParams) {
      ...
      Map map = incorex.orderCancel(signatureCreator, apiKey, exchange.getNonceFactory(), orderId);
  ...
  public UserTrades getTradeHistory(TradeHistoryParams params) throws IOException {
    ...
    if (params instanceof IncorexTradeHistoryParams) {
      IncorexTradeHistoryParams incorexTradeHistoryParams = (IncorexTradeHistoryParams) params;
      currencyPairs.addAll(incorexTradeHistoryParams.getCurrencyPairs());
  ...
  public Collection<Order> getOrder(OrderQueryParams... orderQueryParams) throws IOException {
    ...
    for (OrderQueryParams orderQueryParam : orderQueryParams) {
      ...
      IncorexUserTrades incorexUserTrades = userTrades(orderId);
      if (incorexUserTrades == null) continue;

      BigDecimal originalAmount = incorexUserTrades.getOriginalAmount();

      for (UserTrade userTrade : incorexUserTrades.getUserTrades()) {
  ...
  public TradeHistoryParams createTradeHistoryParams() {
    return new IncorexTradeHistoryParams();
  }
}
